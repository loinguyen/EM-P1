...
public final class SlidingWindowCounter<T> implements Serializable {
    ...
    /**
     * edit by OaiDQ.
     * receive additional point and pass it to incrementCount method of base class. 
     */
    public void incrementCount(T obj, int point) {
    	Log.info("SlidingWindowCounter - incrementCount");
        objCounter.incrementCount(obj, point, headSlot);
    }
